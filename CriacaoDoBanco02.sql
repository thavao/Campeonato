...
AS
	BEGIN
		...
		select top 1 @qtdTimes = Id  FROM [Time] ORDER BY Id DESC;
		
		IF(@qtdTimes < 5 or @qtdTimes IS NULL)
			INSERT INTO Time
...
CREATE PROCEDURE Inserir_Partida
	...
	DECLARE 
		...
		SELECT @qtdPartida = COUNT(Id) FROM Partida

		if((@qtdPartida = (@qtdTimes * @qtdTimes) - @qtdTimes))
			RETURN 5
...
EXEC Inserir_Time 'Tropa do Pãozinho', 'TPO', '2024-04-15'
EXEC Inserir_Time '5by5 Football Club', 'Five', '2020-07-24'
EXEC Inserir_Time 'Clube dos Amigos da Rua Nove', 'Amigos', '2015-09-12'


EXEC Inserir_Partida 1, 2, '2024-05-19', 2, 12;
EXEC Inserir_Partida 1, 3, '2024-06-15', 14, 12;
EXEC Inserir_Partida 2, 1, '2024-05-14', 7, 6;
EXEC Inserir_Partida 2, 3, '2024-06-14', 7, 2;
EXEC Inserir_Partida 3, 1, '2024-07-04', 4, 10;
EXEC Inserir_Partida 3, 2, '2024-05-31', 7, 4;
